...
A toast system for transient feedback and notifications.
...
```bash
npx shadcn@latest add https://sunlace.dev/r/sonner.json
```

**Dependencies:** `@hugeicons/core-free-icons`, `@hugeicons/react`, `next-themes`, `sonner`

### Manual

```bash
npm install @hugeicons/core-free-icons @hugeicons/react next-themes sonner clsx tailwind-merge
```
