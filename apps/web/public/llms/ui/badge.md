...
A compact label for status and metadata.
...
```bash
npx shadcn@latest add https://sunlace.dev/r/badge.json
```
...
const badgeVariants = cva(
  "group/badge inline-flex h-8 w-fit shrink-0 items-center justify-center gap-1.5 overflow-hidden rounded-4xl border border-transparent bg-clip-padding px-3 text-sm font-medium whitespace-nowrap shadow-[0_1px_1px_rgb(0_0_0/0.08),0_3px_8px_rgb(0_0_0/0.06),inset_0_1px_rgb(255_255_255/0.16)] transition-[background-color,border-color,box-shadow,color,filter] duration-150 ease-[cubic-bezier(0.16,1,0.3,1)] outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-2.5 has-data-[icon=inline-start]:pl-2.5 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:shadow-[0_1px_1px_rgb(0_0_0/0.35),0_4px_12px_rgb(0_0_0/0.28),inset_0_1px_rgb(255_255_255/0.10)] dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-4!",
  {
    variants: {
      variant: {
        default:
          "border-[color-mix(in_oklch,var(--primary),black_24%)] bg-[linear-gradient(180deg,color-mix(in_oklch,var(--primary),white_9%)_0%,var(--primary)_52%,color-mix(in_oklch,var(--primary),black_6%)_100%)] text-primary-foreground shadow-[0_1px_1px_rgb(0_0_0/0.18),0_2px_5px_rgb(0_0_0/0.08),inset_0_1px_0_rgb(255_255_255/0.12)] hover:border-[color-mix(in_oklch,var(--primary),black_30%)] hover:bg-[linear-gradient(180deg,color-mix(in_oklch,var(--primary),white_4%)_0%,color-mix(in_oklch,var(--primary),black_4%)_52%,color-mix(in_oklch,var(--primary),black_14%)_100%)] hover:shadow-[0_1px_1px_rgb(0_0_0/0.2),0_3px_8px_rgb(0_0_0/0.12),inset_0_1px_0_rgb(255_255_255/0.08)] dark:border-[color-mix(in_oklch,var(--primary),black_36%)] dark:bg-[linear-gradient(180deg,color-mix(in_oklch,var(--primary),white_16%)_0%,color-mix(in_oklch,var(--primary),black_4%)_42%,color-mix(in_oklch,var(--primary),black_16%)_100%)] dark:shadow-[0_0_0_1px_rgb(255_255_255/0.05),0_6px_14px_rgb(0_0_0/0.36),inset_0_1px_0_rgb(255_255_255/0.16)] dark:hover:border-[color-mix(in_oklch,var(--primary),black_44%)] dark:hover:bg-[linear-gradient(180deg,color-mix(in_oklch,var(--primary),white_10%)_0%,color-mix(in_oklch,var(--primary),black_10%)_42%,color-mix(in_oklch,var(--primary),black_22%)_100%)] dark:hover:shadow-[0_0_0_1px_rgb(255_255_255/0.06),0_8px_18px_rgb(0_0_0/0.42),inset_0_1px_0_rgb(255_255_255/0.12)]",
        outline:
